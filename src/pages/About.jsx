      ...
      <section className="text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center">
            <div className="bg-gray-200 p-4 rounded-full mb-4 w-32 h-32 flex items-center justify-center">
              {/* Placeholder for team member image */}
              <img
                src="https://png.pngtree.com/png-clipart/20231017/original/pngtree-3d-employee-video-chat-png-image_13340388.png"
                alt="Team Member 1"
